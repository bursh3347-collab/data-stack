# 📋 SOURCES — All Source Projects

> Every project analyzed in this repository, with GitHub links, star counts, and license information.
...
|---|---------|--------|-------|---------|------|-------|
| 1 | DuckDB | [duckdb/duckdb](https://github.com/duckdb/duckdb) | 37,461 | MIT | 86 | 2026-04-15 |
| 2 | Polars | [pola-rs/polars](https://github.com/pola-rs/polars) | 38,187 | MIT | 83 | 2026-04-15 |
...
- **MIT / BSD / ISC / Apache-2.0**: Safe for commercial use. Include original license notice.
- **AGPL-3.0 (Grafana, Metabase)**: Any derivative work served over a network must be open-sourced. **Do NOT use code in proprietary SaaS.** Study patterns and re-implement.

## Data Collection Method

All data collected via GitHub MCP on 2026-04-15/16 from official repositories. TEMC scores calculated using: T(Technology)×0.25 + E(Ecosystem)×0.20 + M(Market)×0.30 + C(Combination)×0.25.
